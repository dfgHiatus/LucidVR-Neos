...
namespace OpenGlovesHaptics
{
	...
	*/
    ...
    public class OpenGlovesHaptics : NeosMod
    {
        ...
        [AutoRegisterConfigKey] static ModConfigurationKey<bool> useIsGrabbing = new("useIsGrabbing", "Lock fingers if something is grabbed", () => true);
        [AutoRegisterConfigKey] static ModConfigurationKey<bool> useRayCasts = new("useRayCasts", "Use raycasts to decide if a finger should be locked", () => true);
        [AutoRegisterConfigKey] static ModConfigurationKey<float> rayCastDistance = new("RayCastDistance", "Distance to raycast from finger segments", () => 0.1f);
        [AutoRegisterConfigKey] static ModConfigurationKey<float> debugTime = new ("DebugTime", "Debug visuals duration", () => 0.1f);
